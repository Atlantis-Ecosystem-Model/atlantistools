...
`atlantistools` is an R package to aid in the data processing and visualization of output from Atlantis models.
Using `atlantistools` helps Atlantis users standardize input/output which facilitates intra and inter model comparisons.
