...
# df_cons <- calculate_consumed_biomass(
#   ref_eat,
#   ref_grazing,
#   ref_dm,
#   ref_vol,
...
# )
#
# df_sp <- calculate_biomass_spatial(
#   ref_nums,
#   ref_structn,
#   ref_resn,
#   ref_n,
...
#
# grob <- plot_spatial_box(
#   bio_spatial,
#   bgm_as_df,
#   select_species = "Cephalopod",
#   timesteps = 3
# )
#
# vol <- agg_data(
...
# data_comp$atoutput <- data_comp$atoutput *
#   runif(n = nrow(data_comp), min = 0.8, max = 1.2)
