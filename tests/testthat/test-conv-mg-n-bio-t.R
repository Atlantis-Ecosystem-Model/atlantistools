...
test_that("test conversion factor and helper functions", {
  ...
  expect_error(extract_param(chars = c("XXX  15", "YYY   25"), variable = "X_CN"), "Variable X_CN not found.")
  expect_error(extract_param(chars = c("X_CN  5.7", "X_CN   6.3"), variable = "X_CN"))
