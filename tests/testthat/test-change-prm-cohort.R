...
pos <- c(
  scan_prm(chars = prm_old, variable = "C_FPS"),
...
test_that("test change_prm_cohort", {
  ...
  expect_equal(
    str_split_twice(char = prm_old[pos[1] + 1], min_only = FALSE) * 2,
