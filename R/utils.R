...
debug_ns <- function() {
  assign("dir", "z:/Atlantis_models/Runs/dummy_01_ATLANTIS_NS/", envir = .GlobalEnv)
  ...
  assign("bps", load_bps(fgs = "functionalGroups.csv", init = "init_NorthSea.nc"), envir = .GlobalEnv)
  assign("fgs", "functionalGroups.csv", envir = .GlobalEnv)
  assign("select_groups", get_groups(fgs = "functionalGroups.csv"), envir = .GlobalEnv)
  assign("bboxes", get_boundary(load_box(bgm = "NorthSea.bgm")), envir = .GlobalEnv)
