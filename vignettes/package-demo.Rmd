...
feeding_plots <- plot_diet(data = setas$diet_dietcheck, wrap_col = "habitat", combine_thresh = 0.03)
...
feeding_plots <- plot_diet(data = setas$diet_specmort, wrap_col = "agecl", combine_thresh = 0.03)
grid.arrange(feeding_plots[[1]])
```
...
plot_data <- combine_ages(dir = d, 
                          ...
                          col = "pred", 
                          prm_biol = "VMPA_setas_biol_fishing_New.prm")
feeding_plots <- plot_diet(data = plot_data, wrap_col = "stanza", combine_thresh = 0.03)
grid.arrange(feeding_plots[[1]])
```
