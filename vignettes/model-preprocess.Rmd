...
3. Save the preprocessed output as a list of dataframes to save computation time and to make it easier to share model output.

Please feel free to modify the vignette to your likings by adding your personal calculation procedures. I will try
...
R project. By doing so there is no need to create the connections to the model files with calls to `file.path()`. You
