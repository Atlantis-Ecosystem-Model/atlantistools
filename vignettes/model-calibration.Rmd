...
diet_data <- combine_ages(dir = model_path, data = result$diet_dietcheck, col = "pred", prm_biol = "VMPA_setas_biol_fishing_New.prm")
marrangeGrob(plot_diet(diet_data, wrap_col = "stanza", combine_thresh = 0.03), nrow = 1, ncol = 1)
```
